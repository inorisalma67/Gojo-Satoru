...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
		    ...
		    「 معك بوت غوجو 🤗 」◣
		    「 افضل بوت عربي 」◣
 「 رابط المجلس لضم نقابتك الي المملكه」◣
		    「https://chat.whatsapp.com/KaV9GY8bbNRCOiUzQCOjBb」◣
		    「 لي اللي يبغا يضم نقابتو」◣`,
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "قائمة استمارات مملكة لور ",
										"description": ".17.",
										"rowId": `${prefix}anon`
									}
								]
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
            ...
            case 'التسجhgjيل': case 'التسجيل': {
                reply`لضم نقابنك الي المملكه

「 _https://chat.whatsapp.com/KaV9GY8bbNRCOiUzQCOjBb 」◣
